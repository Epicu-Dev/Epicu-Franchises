...
import { ChevronUpIcon, ChevronDownIcon, ChevronDownIcon as ChevronDown } from '@heroicons/react/24/outline';
...
export default function DataPage() {
  ...
  const getSortIcon = (field: string) => {
    if (sortField !== field) {
      return <ChevronUpIcon className="h-4 w-4 text-gray-400 dark:text-gray-500" />;
    }
