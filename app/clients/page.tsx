...
export default function ClientsPage() {
  ...
  useEffect(() => {
    fetchClients();
  }, [pagination.currentPage, searchTerm, selectedCategory, sortField, sortDirection]);
      ...
      <Card className="w-full">
        <CardBody className="p-6">
            ...
            <TableBody>
              {clients.map((client) => (
                <TableRow key={client.id}>
                  ...
                  <TableCell>
                    <span className={`px-2 py-1 text-xs font-medium rounded ${getCategoryBadgeColor(client.categorie || 'Shop')}`}>
                  ...
                  <TableCell>
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusBadgeColor(client.facturePublication)}`}>
          ...
          <div className="text-center mt-4 text-sm text-gray-500">
            Affichage de {clients.length} client(s) sur {pagination.totalItems} au total
          </div>
        </CardBody>
      </Card>
          ...
          <ModalBody>
            <div className="space-y-4">
              <Input
                ...
                onChange={(e) => setNewClient(prev => ({ ...prev, raisonSociale: e.target.value }))}
                isRequired
              />
              <Input
                label="Email"
              ...
              <Select
                ...
                onSelectionChange={(keys) => setNewClient(prev => ({ ...prev, statut: Array.from(keys)[0] as 'actif' | 'inactif' | 'prospect' }))}
              >
              ...
              <Textarea
                ...
                onChange={(e) => setNewClient(prev => ({ ...prev, commentaire: e.target.value }))}
              />
            </div>
          </ModalBody>
          <ModalFooter>
            ...
            <Button className="bg-black text-white dark:bg-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200" onPress={handleAddClient}>
              Ajouter
            </Button>
          </ModalFooter>
        </ModalContent>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, raisonSociale: e.target.value }) : null)}
                    isRequired
                    classNames={{
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, ville: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Select
                    ...
                    selectedKeys={editingClient.categorie ? [editingClient.categorie] : []}
                    onSelectionChange={(keys) => setEditingClient(prev => prev ? ({ ...prev, categorie: Array.from(keys)[0] as string }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium"
                    }}
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, telephone: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, numeroSiret: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                ...
                <div className="space-y-4">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, commentaire: e.target.value }) : null)}
                    minRows={3}
                    classNames={{
                      input: "text-sm"
                    }}
                ...
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, dateSignatureContrat: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, datePublicationContenu: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, datePublicationFacture: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Select
                    ...
                    selectedKeys={editingClient.statutPaiementContenu ? [editingClient.statutPaiementContenu] : []}
                    onSelectionChange={(keys) => setEditingClient(prev => prev ? ({ ...prev, statutPaiementContenu: Array.from(keys)[0] as 'Payée' | 'En attente' | 'En retard' }) : null)}
                    classNames={{
                      label: "text-sm font-medium"
                    }}
                  >
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, montantFactureContenu: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, montantPaye: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, dateReglementFacture: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, restantDu: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, montantSponsorisation: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, montantAddition: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                ...
                <div className="space-y-4">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, commentaireCadeauGerant: e.target.value }) : null)}
                    minRows={4}
                    classNames={{
                      input: "text-sm"
                    }}
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingClient(prev => prev ? ({ ...prev, montantCadeau: e.target.value }) : null)}
                    isRequired
                    classNames={{
                      label: "text-sm font-medium",
                      input: "text-sm"
                  ...
                  <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="flex gap-2 ml-auto">
                      <Button
                        size="sm"
                        variant="light"
                        className={editingClient.tirageAuSort === false ? "bg-gray-200" : ""}
                        onPress={() => setEditingClient(prev => prev ? ({ ...prev, tirageAuSort: false }) : null)}
                      >
                        Annuler
                      </Button>
                      <Button
                        ...
                        onPress={() => setEditingClient(prev => prev ? ({ ...prev, tirageAuSort: true }) : null)}
                      >
                        Ajouter
                      </Button>
                    </div>
